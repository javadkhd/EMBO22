...
#define UPDATE_URL      "http://embo.javadkhadem.com/updates.json"
...
#define EMBO_ABOUT_TXT  "<b><big>EMBedded Oscilloscope " APP_VERSION "</big></b><br><br>CTU FEE © 2020-2021 Javad Khadem<br><br>\
